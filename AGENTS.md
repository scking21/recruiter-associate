...
This is the separate recruiter hackathon project. Trail acquisition remains parked in its own repository. Keep this project's state in docs/HACKATHON.md and its README.

Use at most two subagents concurrently with distinct ownership. Preserve other agents' edits. Keep checks focused and do not run provider benchmarks by default.
